      ...
      <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <thead>
            ...
            <th class="align-middle text-center">NamaLengkap</th>
          ...
          ?>
            <tr>
                ...
                <a  href="javascript:void(0)" class='open_modal btn btn-info'  id='<?php echo  $r['id_user']; ?>'><img src="https://img.icons8.com/material-outlined/24/ffffff/file-preview.png"/></a>
                <a href="javascript:void(0)" class="delete_modal btn btn-danger" data-id='<?php echo  $r['id_user']; ?>'><img src="https://img.icons8.com/material-rounded/24/ffffff/delete-trash.png"/></a>
                </td>
            </tr>
          <?php } ?>
          </tbody>
