            ...
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="destinasi" placeholder="Raja Ampat" value="Raja Ampat" disabled>
                </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="harga">
                      <option value=""></option>
                      <option value="12680000">Adult Twin Share</option>
                      <option value="12680000">Child Twin Share</option>
                      <option value="11680000">Child With Extra Bed</option>
                    </select>
              </div>
                <div class="form-group col-md-6">
                  <label>‎</label>
