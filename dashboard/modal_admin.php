<?php
	...
	$modal=mysqli_query($conn,"SELECT * FROM pelanggan WHERE id_user='$id_user'");
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
        	<form id="form-update" action="edit_admin.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group" style="padding-bottom: 20px;">
                  <label for="Modal Divisi">Divisi</label>
                  <input type="text" name="divisi" id="edit-divisi" class="form-control" value="<?php echo $r['divisi']; ?>"disabled/>
                </div>
