            ...
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="destinasi" placeholder="Derawan" value="Derawan" disabled>
                </div>
                <div class="form-group">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="harga">
                      <option value=""></option>
                      <option value="1850000">Adult Twin Share</option>
                      <option value="1850000">Child Twin Share</option>
                    </select>
              </div>
                <div class="form-group col-md-6">
                  <label>‎</label>
