            ...
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="destinasi" placeholder="Ijen" value="Ijen" disabled>
                </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="harga">
                      <option value=""></option>
                      <option value="2750000">Adult Twin Share</option>
                      <option value="2750000">Child Twin Share</option>
                      <option value="2300000">Child Without Bed</option>
                      <option value="2750000">Child With Extra Bed</option>
                    </select>
              </div>
                <div class="form-group col-md-6">
                  <label>‎</label>
