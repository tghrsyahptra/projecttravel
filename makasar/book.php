            ...
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="destinasi" placeholder="Rammang" value="Rammang" disabled>
                </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="harga">
                      <option value=""></option>
                      <option value="4150000">Adult Twin Share</option>
                      <option value="4150000">Child Twin Share</option>
                      <option value="2150000">Child Without Bed</option>
                      <option value="3150000">Child With Extra Bed</option>
                    </select>
              </div>
                <div class="form-group col-md-6">
                  <label>‎</label>
